                    ...
                    <div class="flex justify-between flex-wrap">
                        <div class="w-0 flex-1 flex">
                            ...
                            <div>
                                ...
                                <div class="flex mt-3">
                                    <a target="_blank" href="https://www.products.panacea-soft.co/psx-builder-qa/project" class="underline text-indigo-500">
            ...
            if (form.token != ""){
                Inertia.post(route('admin.dashboard.checkConnection'),form,{
                    ...
                    onError: () => {
                        ...
                        //     trans('core__error_autosync_title'),
                        //     "Testing",
                        //     trans('core__error_confirm'))
        ...
        function setupClicked(){
            if (form.token != ""){
                Inertia.post(route('admin.dashboard.setupAutoSync'),form,{
                    ...
                    onSuccess: () => {
                        ps_loading_circle_dialog.value.closeModal();
                        // localStorage.removeItem('setupAutoSync');
