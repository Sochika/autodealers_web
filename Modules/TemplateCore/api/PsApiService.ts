...
export default class PsApiService extends PsApi {
    ...
    **/
    ...
    static async getCustomFieldList<T extends PsObject<T>>(obj: T, loginUserId: String): Promise<PsResource<T[]>> {
        const url: String = PsUrl.ps_customfield_url + "&login_user_id=" + loginUserId;
        return await PsApi.getData<T, T[]>(obj, url);
    }
