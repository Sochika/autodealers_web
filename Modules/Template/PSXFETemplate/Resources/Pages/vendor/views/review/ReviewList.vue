        ...
        <template #content>
            <div class="mt-32 mb-10">
                ...
                <div class=" mb-4 flex items-center mt-8">
                    ...
                    <ps-route-link :to="{   name: 'fe_other_profile',
                                query: { userId: breadcrumbuserProvider.user?.data?.userId }}" v-if="breadcrumbuserProvider.user?.data?.userId != loginUserId">
                        <ps-label
                            class=" cursor-pointer text-xs lg:text-base">
                        ...
                        <div class="w-full flex flex-col rounded-lg">
                            ...
                            <div class="flex flex-col mt-5">
                                <div class="flex justify-between mb-2">
                                    ...
                                    <ps-label-title-3> {{reviewuserProvider.user.data ? reviewuserProvider.user.data.ratingDetail?.fiveStarPercent : 0}} %</ps-label-title-3>
                                </div>
                                <div class="">
                                    <base-progress :color="'bg-fePrimary-500'" :percentage="reviewuserProvider.user.data ? reviewuserProvider.user?.data?.ratingDetail?.fiveStarPercent : 0" class="mx-2 mb-2 h-20"/>
                                </div>
                            ...
                            <div class="flex flex-col mt-5">
                                <div class="flex justify-between mb-2">
                                    ...
                                    <ps-label-title-3> {{reviewuserProvider.user.data ? reviewuserProvider.user.data.ratingDetail?.fourStarPercent : 0}} %</ps-label-title-3>
                                </div>
                                <div class="">
                                    <base-progress :color="'bg-fePrimary-500'" :percentage="reviewuserProvider.user.data ? reviewuserProvider.user.data.ratingDetail?.fourStarPercent : 0" class="mx-2 mb-2 h-20"/>
                                </div>
                            </div>
                            ...
                            <div class="flex flex-col mt-5">
                                <div class="flex justify-between mb-2">
                                    ...
                                    <ps-label-title-3> {{reviewuserProvider.user.data ? reviewuserProvider.user.data.ratingDetail?.threeStarPercent : 0}} %</ps-label-title-3>
                                </div>
                                <div class="">
                                    <base-progress :color="'bg-fePrimary-500'" :percentage="reviewuserProvider.user.data ? reviewuserProvider.user.data.ratingDetail?.threeStarPercent : 0" class="mx-2 mb-2 h-20"/>
                                </div>
                            </div>
                            ...
                            <div class="flex flex-col mt-5">
                                <div class="flex justify-between mb-2">
                                    ...
                                    <ps-label-title-3> {{reviewuserProvider.user.data ? reviewuserProvider.user.data.ratingDetail?.twoStarPercent : 0}} %</ps-label-title-3>
                                </div>
                                <div class="">
                                    <base-progress :color="'bg-fePrimary-500'" :percentage="reviewuserProvider.user.data ? reviewuserProvider.user.data.ratingDetail?.twoStarPercent : 0" class="mx-2 mb-2 h-20"/>
                                </div>
                            </div>
                            ...
                            <div class="flex flex-col mt-5">
                                <div class="flex justify-between mb-3">
                                    ...
                                    <ps-label-title-3> {{reviewuserProvider.user.data ? reviewuserProvider.user.data.ratingDetail?.oneStarPercent : 0}} %</ps-label-title-3>
                                </div>
                                <div class="">
                                    <base-progress :color="'bg-fePrimary-500'" :percentage="reviewuserProvider.user.data ? reviewuserProvider.user.data.ratingDetail?.oneStarPercent : 0" class="mx-2 mb-2 h-20"/>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="flex flex-col mt-10">
                    <div class="grid grid-cols-4 sm:grid-cols-8 lg:grid-cols-9 gap-4" v-if="ratinglistProvider.ratingList?.data != null">
                        <!-- Rating User Listing -->
                        <div class="w-full col-span-4 sm:col-span-4 lg:col-span-3 " v-for="rate in ratinglistProvider.ratingList.data" :key="rate.id">
                            <rating-horizontal :rate="rate" :onClick="rateClicked"/>
                        </div>
                        <!-- End Rating User -->
                    </div>

                    <div class="grid lg:grid-cols-12 sm:grid-cols-8 grid-cols-4  gap-4 sm:gap-3.5 lg:gap-4" v-else-if="ratinglistProvider.loading.value == true">
                ...
                <ps-button v-if="ratinglistProvider.loading.value == false" class="mx-auto mt-6" @click="loadMore" :class="ratinglistProvider.isNoMoreRecord.value || ratinglistProvider.ratingList?.data == null ? 'hidden' : ''">{{  $t("list__load_more") }} </ps-button>
