        ...
        <template #content>
            <div class="mt-32">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 gap-6 sm:gap-5 md:gap-6">
                    <!-- profile card start -->
                    <div>
                        <div class="flex flex-col p-4 gap-2 bg-feSecondary-50 dark_bg-feSecondary-800 rounded">
                            ...
                            <!-- Blue Mark Section -->
                            <div v-if="userStore.user.data?.isVerifybluemark == '0' || userStore.user.data?.isVerifybluemark == '1'" class="bg-feInfo-50 border border-feInfo-500 px-4 py-2 flex gap-2 justify-center rounded cursor-pointer" @click="openApplyUserBluemark(loginUserId)">
                            ...
                            <div v-else-if="userStore.user.data?.isVerifybluemark == '2'" class="bg-feWarning-50 border border-feWarning-500 px-4 py-2 flex gap-2 justify-center rounded cursor-pointer">
                                <ps-icon class="text-feInfo-500 dark:text-feInfo-500" name="checkCircle" w="24" h="24" />
                                <ps-label textColor="text-feWarning-500">{{ $t("bluemark__pending") }}</ps-label>
                            </div>
                            <div v-else-if="userStore.user.data?.isVerifybluemark == '3'" class="bg-feError-50 border border-feError-500 px-4 py-2 flex gap-2 justify-center rounded cursor-pointer" @click="openApplyUserBluemark(loginUserId)">
                                <ps-icon class="text-feInfo-500 dark:text-feInfo-500" name="checkCircle" w="24" h="24" />
                    ...
                    <div v-if="appInfoStore?.appInfo?.data?.psAppSetting?.isPaidApp == '1' && limitProvider.buyadList?.data != null" class="w-full sm:col-span-2 lg:col-span-2 xl:col-span-3">
                    ...
                    <div v-if="appInfoStore?.appInfo?.data?.psAppSetting?.isPaidApp == '0'" class="w-full sm:col-span-2 lg:col-span-2 xl:col-span-3">
                        ...
                        <div v-if="itempaidProvider.paidAdItemList?.data != null">
                            <div class="flex justify-between items-center">
                                ...
                                <ps-route-link v-if="itempaidProvider.paidAdItemList?.data != null" class="justify-end flex flex-grow-0" :to="{ name: 'fe_paid_items'}">
                                    <ps-button class="flex flex-row " theme="bg-fePrimary-500 dark:bg-feAccent-500 text-feAchromatic-50 dark:text-feAchromatic-900 capitalize px-4 py-2">
                                        {{ $t("fe__view_all") }}
                                    </ps-button>
                                </ps-route-link>
                            </div>
                            <div class="w-full sm:mt-6 mt-4 flex flex-col" :class="paidAppZeroItemGrid">
                        ...
                        <div v-if="itemactiveProvider.itemList?.data != null">
                            <div class="flex justify-between items-center sm:mt-8 mt-6">
                                ...
                                <ps-route-link v-if="itemactiveProvider.itemList?.data != null"  class="justify-end flex mt-2 flex-grow-0" :to="{name: 'fe_active_items' }">
                                    <ps-button class="flex flex-row " theme="bg-fePrimary-500 dark:bg-feAccent-500 text-feAchromatic-50 dark:text-feAchromatic-900 capitalize px-4 py-2">
                                        {{ $t("fe__view_all") }}
                                    </ps-button>
                                </ps-route-link>
                            ...
                            <div class="w-full sm:mt-6 mt-4 flex flex-col" :class="paidAppZeroItemGrid">
                                <!-- Active Listing -->
                                <div class="hidden xl:block" v-for="item in itemactiveProvider.itemList.data.slice(0, 3)" :key="item.id">
                                    <profile-item-horizontal-item  :item="item" storeName="active"/>
                                </div>

                                <div class="hidden lg:block xl:hidden" v-for="item in itemactiveProvider.itemList.data.slice(0, 2)" :key="item.id">
                                    <profile-item-horizontal-item  :item="item" storeName="active"/>
                                </div>

                                <div class="hidden md:block lg:hidden" v-for="item in itemactiveProvider.itemList.data.slice(0, 2)" :key="item.id">
                                    <profile-item-horizontal-item  :item="item" storeName="active"/>
                                </div>

                                <div class="hidden sm:block md:hidden" v-for="item in itemactiveProvider.itemList.data.slice(0, 2)" :key="item.id">
                                    <profile-item-horizontal-item  :item="item" storeName="active"/>
                                </div>

                                <div class="sm:hidden" v-for="item in itemactiveProvider.itemList.data.slice(0, 1)" :key="item.id">
                                    <profile-item-horizontal-item  :item="item" storeName="active"/>
                                </div>
                                <!-- END Active Listing -->
                            </div>
                        </div>
                        <div v-else-if="itemactiveProvider.itemList.data == null && itemactiveProvider.loading.value ">
                            <ps-label-header-4 class="sm:mt-8 mt-6"> {{ $t("profile__active_listing") }} </ps-label-header-4>
                            <div class="w-full sm:mt-6 mt-4" :class="itemSkeletorGrid">
                        ...
                        <div v-if="itempendingProvider.itemList?.data != null" class="">
                            <div class="flex justify-between items-center sm:mt-8 mt-6">
                                ...
                                <ps-route-link v-if="itempendingProvider.itemList?.data != null" class="justify-end flex mt-2 flex-grow-0" :to="{name: 'fe_pending_items' }">
                                    <ps-button class="flex flex-row " theme="bg-fePrimary-500 dark:bg-feAccent-500 text-feAchromatic-50 dark:text-feAchromatic-900 capitalize px-4 py-2">
                                        {{ $t("fe__view_all") }}
                                    </ps-button>
                                </ps-route-link>
                        ...
                        <div v-if="itemrejectProvider.itemList?.data != null">
                            <div class="flex justify-between items-center sm:mt-8 mt-6">
                                ...
                                <ps-route-link v-if="itemrejectProvider.itemList?.data != null"  class="justify-end flex mt-2 flex-grow-0" :to="{name: 'fe_reject_items' }">
                                    <ps-button class="flex flex-row " theme="bg-fePrimary-500 dark:bg-feAccent-500 text-feAchromatic-50 dark:text-feAchromatic-900 capitalize px-4 py-2">
                                        {{ $t("fe__view_all") }}
                                    </ps-button>
                                </ps-route-link>
                        ...
                        <div v-if="favouriteitemProvider.favouriteItemList?.data != null">
                            <div class="flex justify-between items-center sm:mt-8 mt-6">
                                ...
                                <ps-route-link v-if="favouriteitemProvider.favouriteItemList?.data != null" class="justify-end flex mt-2 mb-4 flex-grow-0" :to="{ name: 'fe_favourite_items'}">
                                    <ps-button class="flex flex-row " theme="bg-fePrimary-500 dark:bg-feAccent-500 text-feAchromatic-50 dark:text-feAchromatic-900 capitalize px-4 py-2">
                                            {{ $t("fe__view_all") }}
                                    </ps-button>
                                </ps-route-link>
                        ...
                        <div v-if="itemSoldoutProvider.itemList?.data != null">
                            <div class="flex justify-between items-center sm:mt-8 mt-6">
                                ...
                                <ps-route-link v-if="itemSoldoutProvider.itemList?.data != null"  class="justify-end flex flex-grow-0 mt-2" :to="{name: 'fe_soldout_items' }">
                                    <ps-button class="flex flex-row " theme="bg-fePrimary-500 dark:bg-feAccent-500 text-feAchromatic-50 dark:text-feAchromatic-900 capitalize px-4 py-2">
                                        {{ $t("fe__view_all") }}
                                    </ps-button>
                                </ps-route-link>
                        ...
                        <div v-if="itemdisableProvider.itemList?.data != null" class="mb-6">
                            <div class="flex justify-between items-center sm:mt-8 mt-6">
                                ...
                                <ps-route-link v-if="itemdisableProvider.itemList?.data != null" class="justify-end flex flex-grow-0 mt-2" :to="{name: 'fe_disable_items' }">
                                    <ps-button class="flex flex-row " theme="bg-fePrimary-500 dark:bg-feAccent-500 text-feAchromatic-50 dark:text-feAchromatic-900 capitalize px-4 py-2">
                                        {{ $t("fe__view_all") }}
                                    </ps-button>
                                </ps-route-link>
                ...
                <div v-if="appInfoStore?.appInfo?.data?.psAppSetting?.isPaidApp == '1'" class="sm:mb-10 mb-8 mt-14">
                        ...
                        <div v-if="itempaidProvider.paidAdItemList?.data != null">
                            ...
                            <div class="w-full sm:mt-6 mt-4 flex flex-col" :class="itemGrid">
                                <!-- Paid & Promote Ads List -->
                                <div class="hidden lg:block" v-for="paiditem in itempaidProvider.paidAdItemList.data.slice(0, 4)" :key="paiditem.id">
                                    <paid-ad-item-horizontal-item  :paiditem="paiditem" />
                                </div>

                                <div class="hidden md:block lg:hidden" v-for="paiditem in itempaidProvider.paidAdItemList.data.slice(0, 3)" :key="paiditem.id">
                                    <paid-ad-item-horizontal-item  :paiditem="paiditem" />
                                </div>

                                <div class="hidden sm:block md:hidden" v-for="paiditem in itempaidProvider.paidAdItemList.data.slice(0, 2)" :key="paiditem.id">
                                    <paid-ad-item-horizontal-item  :paiditem="paiditem" />
                                </div>

                                <div class="sm:hidden" v-for="paiditem in itempaidProvider.paidAdItemList.data.slice(0, 1)" :key="paiditem.id">
                                    <paid-ad-item-horizontal-item  :paiditem="paiditem" />
                                </div>
                                <!-- END Paid & Promote Ads List -->
                            </div>
                        ...
                        <div v-if="itemactiveProvider.itemList?.data != null">
                            <div class="flex justify-between items-center sm:mt-8 mt-6">
                                <ps-label-header-4> {{ $t("profile__active_listing") }} </ps-label-header-4>
                                <ps-route-link v-if="itemactiveProvider.itemList?.data != null" class="justify-end flex flex-grow-0 mt-2" :to="{name: 'fe_active_items' }">
                                    <ps-button class="flex flex-row " theme="bg-fePrimary-500 dark:bg-feAccent-500 text-feAchromatic-50 dark:text-feAchromatic-900 capitalize px-4 py-2">
                                        {{ $t("fe__view_all") }}
                                    </ps-button>
                                </ps-route-link>
                            ...
                            <div class="w-full sm:mt-6 mt-4 flex flex-col" :class="itemGrid">
                                <!-- Active Listing -->
                                <div class="hidden lg:block" v-for="item in itemactiveProvider.itemList.data.slice(0, 4)" :key="item.id">
                                    <profile-item-horizontal-item  :item="item" storeName="active"/>
                                </div>

                                <div class="hidden md:block lg:hidden" v-for="item in itemactiveProvider.itemList.data.slice(0, 3)" :key="item.id">
                                    <profile-item-horizontal-item  :item="item" storeName="active"/>
                                </div>
                        ...
                        <div v-if="itempendingProvider.itemList?.data != null" class="">
                            <div class="flex justify-between items-center sm:mt-8 mt-6">
                                <ps-label-header-4 class="mt-3 font-medium"> {{ $t("profile__pending_listing") }} </ps-label-header-4>
                                <ps-route-link v-if="itempendingProvider.itemList?.data != null" class="justify-end flex flex-grow-0 mt-2" :to="{name: 'fe_pending_items' }">
                                    <ps-button class="flex flex-row " theme="bg-fePrimary-500 dark:bg-feAccent-500 text-feAchromatic-50 dark:text-feAchromatic-900 capitalize px-4 py-2">
                                        {{ $t("fe__view_all") }}
                                    </ps-button>
                                </ps-route-link>
                        ...
                        <div v-if="itemrejectProvider.itemList?.data != null" class="">
                            <div class="flex justify-between items-center sm:mt-8 mt-6">
                                <ps-label-header-4> {{ $t("profile__rejected_listing") }} </ps-label-header-4>
                                <ps-route-link v-if="itemrejectProvider.itemList?.data != null" class="justify-end flex flex-grow-0 mt-2" :to="{name: 'fe_reject_items' }">
                                    <ps-button class="flex flex-row " theme="bg-fePrimary-500 dark:bg-feAccent-500 text-feAchromatic-50 dark:text-feAchromatic-900 capitalize px-4 py-2">
                                        {{ $t("fe__view_all") }}
                                    </ps-button>
                                </ps-route-link>
                        ...
                        <div v-if="favouriteitemProvider.favouriteItemList?.data != null" class=" ">
                            <div class="flex justify-between items-center sm:mt-8 mt-6">
                                 <ps-label-header-4> {{ $t("profile__favourite_posts") }} </ps-label-header-4>
                                <ps-route-link v-if="favouriteitemProvider.favouriteItemList?.data != null" class="justify-end flex flex-grow-0 mt-2 mb-4" :to="{ name: 'fe_favourite_items'}">
                                    <ps-button class="flex flex-row " theme="bg-fePrimary-500 dark:bg-feAccent-500 text-feAchromatic-50 dark:text-feAchromatic-900 capitalize px-4 py-2">
                                            {{ $t("fe__view_all") }}
                                    </ps-button>
                                </ps-route-link>
                            ...
                            <div class="w-full sm:mt-6 mt-4 flex flex-col" :class="itemGrid">
                                <!-- Favourite Items List -->
                                <div class="hidden lg:block" v-for="favouriteItem in favouriteitemProvider.favouriteItemList.data.slice(0, 4)" :key="favouriteItem.id">
                                    <item-horizontal-item :item="favouriteItem" storeName="favourite"/>
                                </div>

                                <div class="hidden md:block lg:hidden" v-for="favouriteItem in favouriteitemProvider.favouriteItemList.data.slice(0, 3)" :key="favouriteItem.id">
                                    <item-horizontal-item :item="favouriteItem" storeName="favourite"/>
                                </div>
...
layout: PsFrontendLayout,
    ...
    setup(props) {
        ...
        itemSoldoutProvider.loadItemList(loginUserId, itemSoldoutProvider.paramHolder);
