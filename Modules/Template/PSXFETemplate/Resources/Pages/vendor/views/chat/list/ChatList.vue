                ...
                <div id="seller" class="flex flex-col mb-16" v-if="isSellerFocus && ps_loading == false">
                    <div class="flex flex-row">
                        ...
                        <div class="flex flex-wrap w-full" v-else>
                            <div class=" mt-2 w-full" v-for="chathistory in chatsellerhistorylistStore.chatHistoryList?.data" :key="chathistory.id">
                    ...
                    <div class="flex flex-row">
                        ...
                        <div v-else class='w-full ' >
                            <div class="flex flex-wrap w-full">
                                <div class="w-full mt-2" v-for="chathistory in chatbuyerhistorylistStore.chatHistoryList.data" :key="chathistory.id">
