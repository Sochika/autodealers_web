    ...
    <div class="">
        <div class="mt-24 w-full">
            <div class="bg-feAchromatic-900 relative">
                <img alt="Placeholder" class=" hidden md:block w-full opacity-60 h-[530px] sm:h-[485px] object-cover"
                    v-lazy=" { src: $page.props.uploadUrl + '/'+appInfoStore.appInfo.data?.frontendConfigSetting?.frontendBanner?.imgPath, error: $page.props.sysImageUrl+'/default_photo.png' }"
                >
                <div class="md:hidden w-full h-[530px] sm:h-[485px] bg-feAchromatic-700"></div>
                <!-- <img alt="Placeholder" class="md:hidden w-full opacity-60 h-[530px] sm:h-[485px] object-cover"
                    v-lazy=" { src: $page.props.thumb3xUrl + '/'+appInfoStore.appInfo.data?.frontendConfigSetting?.frontendBanner?.imgPath, loading: $page.props.sysImageUrl+'/loading_gif.gif', error: $page.props.sysImageUrl+'/default_photo.png' }"
                > -->
                <div class="absolute top-0 w-full h-full flex flex-col justify-center gap-5 sm:gap-8">
                    <div class="text-center">
                        <ps-label class="text-xl font-semibold mb-4 sm:text-4xl xl:text-5xl" textColor="text-fePrimary-50">{{ $t("home__banner_header") }}</ps-label>
                        <ps-label class="text-base font-normal px-10" textColor="text-fePrimary-50">{{ $t("home__banner_desc") }}</ps-label>
                    </div>
                    <div class="bg-feAchromatic-50 dark_bg-feSecondary-800 rounded-lg px-4 py-4 sm:py-2 mx-auto">
                        <search-for-large-screem />
                    </div>
                    <div class="">
                        <ps-label class="text-center text-sm font-normal mb-4" textColor="text-fePrimary-50">{{ $t("home__popular_categories") }}</ps-label>
                        <div class="flex justify-center flex-wrap gap-x-2 sm:gap-x-4 gap-y-4" v-if="popularCategoryStore.itemList?.data != null">
                            <div v-for="category in popularCategoryStore.itemList.data.slice(0,6)" :key="category.catId" class="">
                                <ps-route-link :to="{name: appInfoStore?.appInfo?.data?.mobileSetting.is_show_subcategory == '1' ? 'fe_sub_category' : 'fe_item_list',
                                    ...
                                    <ps-button class="flex flex-row " rounded="rounded" colors="bg-feAchromatic-50 text-feSecondary-800 dark_bg-feSecondary-800 dark_text-feSecondary-100" hover="" focus="">
                                        {{category.catName}}
                                    </ps-button>
                                </ps-route-link>
                            </div>
            ...
            <template #content>
                <div class="flex justify-between items-center mb-6">
                    ...
                    <ps-route-link :to="{name: 'fe_category.index'}" >
                        <ps-button class="flex flex-row" padding="p-2 sm:px-4 sm:py-2" shadow="shadow-sm" rounded="rounded" hover="" focus="" border="border border-feSecondary-200 dark_border-feSecondary-800" colors="bg-feAchromatic-50 text-feSecondary-800 dark_bg-feSecondary-800 dark_text-feSecondary-200">
                            <ps-label class="hidden sm:inline">{{ $t("list_fe__view_all_label")}}</ps-label>
                            <ps-icon class="sm:ms-2 block rtl:hidden" textColor="dark_text-feSecondary-200" name="rightChervon" h="24" w="24" />
                            <ps-icon class="sm:ms-2 hidden rtl:block" textColor="dark_text-feSecondary-200" name="leftChervon" h="24" w="24"/>
                        </ps-button>
                    </ps-route-link>
                </div>
                <div class="grid grid-cols-4 sm:grid-cols-4 md:grid-cols-9 lg:grid-cols-12 xl:gap-6 gap-4 sm:gap-6 " v-if="categoryStore.itemList?.data != null">
                    <div v-for="category in categoryStore.itemList.data.slice(0,8)" :key="category.catId" class="w-full col-span-2 md:col-span-3 lg:col-span-4 xl:col-span-3 xl:block hidden">
                        <ps-route-link
                    ...
                    <div v-for="category in categoryStore.itemList.data.slice(0,6)" :key="category.catId" class="w-full col-span-2 md:col-span-3 lg:col-span-4 xl:col-span-3 hidden sm:block xl:hidden">
                        <ps-route-link
                            :to="{name: appInfoStore?.appInfo?.data?.mobileSetting.is_show_subcategory == '1' ? 'fe_sub_category' : 'fe_item_list',
                            query: {
                                cat_id: category.catId,
                ...
                <div v-else 
                    class="grid grid-cols-4 sm:grid-cols-4 md:grid-cols-9 lg:grid-cols-12 xl:gap-6 gap-4 sm:gap-6 ">
        ...
        <div class="bg-feSecondary-800 py-9 mt-10">
            <div class="w-full lg:w-large xl:w-feLarge mx-auto">
                <ps-label-header-3 class="text-center" textColor="text-feAchromatic-50">{{ $t("home__how_it_works")}}</ps-label-header-3>
                <div class="flex justify-between flex-col sm:flex-row sm:flex-wrap md:flex-nowrap gap-4 sm:gap-x-2 sm:gap-y-6 md:gap-2 lg:gap-4 xl:gap-20 mt-4 sm:mt-10">
                    <div class="w-64 sm:w-80 md:w-60 lg:w-full mx-auto">
                        ...
                        <div class="flex flex-col items-center">
                            <ps-label-header-6 textColor="text-feAchromatic-50" class="my-2">{{ $t("home__search_or_list") }}</ps-label-header-6>
                            <ps-label class="text-center" textColor="text-feAchromatic-500">{{ $t("home__search_or_list__desc") }}</ps-label>
                        </div>
                    </div>
                    <div class="w-64 sm:w-80 md:w-60 lg:w-full mx-auto">
                        <div class="h-40 sm:w-64 md:w-60 sm:mx-auto relative overflow-hidden">
                        ...
                        <div class="flex flex-col items-center">
                            <ps-label-header-6 textColor="text-feAchromatic-50" class="my-2">{{ $t("home__connect") }}</ps-label-header-6>
                            <ps-label class="text-center" textColor="text-feAchromatic-500">{{ $t("home__connect__desc") }}</ps-label>
                        </div>
                    </div>
                    <div class="w-64 sm:w-80 md:w-60 lg:w-full mx-auto">
                        <div class="h-40 sm:w-64 md:w-60 sm:mx-auto relative overflow-hidden">
                        ...
                        <div class="flex flex-col items-center">
                            <ps-label-header-6 textColor="text-feAchromatic-50" class="my-2">{{ $t("home__fe_complete_transaction") }}</ps-label-header-6>
                            <ps-label class="text-center" textColor="text-feAchromatic-500">{{ $t("home__fe_complete_transaction__desc") }}</ps-label>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="xl:w-feLarge lg:w-large md:w-full md:px-6 lg:px-0 mx-auto">
            <!-- Start feature items -->
            <div class="bg-feSecondary-50 dark_bg-feAchromatic-900 flex flex-col sm:flex-row justify-between gap-8 sm:gap-5 mt-10 px-4 py-6 sm:p-10">
                <div class="md:w-64 flex flex-col gap-4">
                    <div class="md:w-64 flex justify-between items-center">
                        <ps-label-header-5 class="font-semibold" textColor="">{{ $t("home__fe_featured_items") }}</ps-label-header-5>
                        <ps-route-link :to="{name: 'fe_item_list', query: paidParams['query'] }" class="block sm:hidden">
                            <ps-button class="flex flex-row" padding="p-2 sm:px-4 sm:py-2" shadow="shadow-sm" rounded="rounded" hover="" focus="" border="border border-feSecondary-200 dark_border-fePrimary-500" colors="bg-fePrimary-500 text-feSecondary-50">
                    ...
                    <div class="mt-4 sm:mt-0">
                        <ps-label class="text-base sm:text-lg font-normal" textColor="dark_text-feSecondary-300">{{ $t("home__fe_featured_items__desc") }}</ps-label>
                    </div>
                    <ps-route-link :to="{name: 'fe_item_list', query: paidParams['query'] }" class="hidden sm:block">
                        <ps-button class="flex flex-row" padding="p-2 sm:px-4 sm:py-2" shadow="shadow-sm" rounded="rounded" hover="" focus="" border="border border-feSecondary-200 dark_border-fePrimary-500" >
                            <ps-label class="hidden sm:inline" textColor="text-feSecondary-50  dark_text-feSecondary-300">{{ $t("list_fe__view_all_label")}}</ps-label>
                ...
                <div class="flex flex-col sm:flex-row sm:justify-center gap-6 sm:gap-4 mt-6 px-0 md:px-8 lg:px-0 xl:px-14">
                    <div class="">
                        <div class="w-full sm:w-60">
                            <ps-label textColor="font-normal text-lg text-feSecondary-800 dark_text-feSecondary-200">{{ $t("dashboard__quota_packages_description")}}</ps-label>
                        </div>
                        <ps-button class="flex flex-row mt-4" shadow="shadow-sm" rounded="rounded" hover="" focus="" border="border border-feSecondary-200 dark_border-feSecondary-800" colors="bg-fePrimary-500 text-feSecondary-50" @click="buyAdClick()">
            ...
            <div v-if="topRatedSellerStore.userList?.data != null">
                ...
                <div class="mt-6 mb-26 sm:mb-0">
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                        <div v-for="user in topRatedSellerStore.userList?.data.slice(0,3)" :key="user.id" class="hidden md:block">
        ...
        <div class="bg-feAchromatic-50 dark_bg-feAchromatic-900">
        ...
        <ps-account-dialog v-if="showAccountModel" ref="ps_account_dialog" :loginUserId="loginUserId" :usernameError="usernameError" :passwordError="passwordError" />
