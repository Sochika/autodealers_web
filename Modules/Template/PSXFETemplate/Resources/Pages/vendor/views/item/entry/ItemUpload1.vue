        ...
        <div
            ...
            <div class="col-span-12 mt-4 lg:px-8  md:px-8 md:col-start-1 sm:col-start-2 px-6 w-full">
                ...
                <!-- <div class="">
                    <div class="flex flex-wrap ">
                        <div class="flex flex-wrap" v-for='index in imageCount' :key='index'>
                            <div v-if="index == 1" class="me-2 mt-2 w-20 relative">

                                <input type="file" accept=".jpg,.jpeg,.png" @change="onImageSelected($event)"
                                    id="fileUpload" style="display: none;">
                                <div @click="defaultClick(index)"
                                    class="cursor-pointer bg-fePrimary-50 w-20 h-20 rounded-2xl flex items-center justify-center absolute">

                                    <img v-if="previewImages[index - 1]?.imgUrl == ''" alt="PlaceholderNo" width="300px"
                                        height="300px" class="rounded-xl w-20 h-20 object-cover "
                                        :src="getImageUrl(index) == '' ? $page.props.sysImageUrl + '/default_photo.png' : getImageUrl(index)" />
                                    <div v-else v-for='image in previewImages' :key="image.id">
                                        <img v-if="image.id == index" alt="PlaceholderSelected" width="300px" height="300px"
                                            class="rounded-xl w-20 h-20 object-cover" :src="image.imgUrl" />
                                    </div>
                            ...
                            <div v-else class="me-2 mt-2 w-20 relative" for="upload-image3">
                                <input type="file" size=1 max=1 accept=".jpg,.jpeg,.png" @change="onImageSelected($event)"
                                    id="fileUpload" style="display: none;" />
                                <div @click="defaultClick(index)"
                                    class="cursor-pointer bg-fePrimary-50 w-20 h-20 rounded-2xl flex items-center justify-center absolute">
                                    <img v-if="previewImages[index - 1]?.imgUrl == ''" alt="Placeholder" width="300px"
                                        height="300px" class="rounded-xl w-20 h-20 object-cover"
                                        :src="getImageUrl(index) == '' ? $page.props.sysImageUrl + '/default_photo.png' : getImageUrl(index)" />
                                    <div v-else v-for='image in previewImages' :key="image.id">
                                        <img v-if="image.id == index" alt="PlaceholderSelected" width="300px" height="300px"
                        ...
                        <ps-label class="lg:mt-2 mt-1  w-full text-xs" textColor="text-feError-500"
                            v-if="validation.imageStatus"> {{ $t("item_entry__image_required_error") }} </ps-label>
                    </div>
            ...
            <div class=" col-span-12 mt-4 lg:px-8  md:px-8 md:col-start-1 sm:col-start-2 px-6 w-full" v-if="galleryLoad">
                ...
                <ps-label class="lg:mt-2 mt-1  w-full text-xs " textColor="text-feError-500" v-if="validation.imageStatus"> {{
                    $t("item_entry__image_required_error") }} </ps-label>
            ...
            <div class="col-span-12  mt-4  lg:px-8  md:px-8 md:col-start-1 sm:col-start-2 px-6 w-full">
                <div class=" w-full">
                        ...
                        <div class="w-full me-6 sm:me-2 mb-4 sm:mb-0"
                            ...
                            <ps-dropdown align="left" class='lg:mt-2 mt-1  w-full' @onClick="loadCategory">
                                <template #select>
                                    ...
                                    <ps-dropdown-select :showCenter="true" :selectedValue="paramHolder1.catName" :placeholder="$t(coreField.placeholder)"/>
                                        ...
                                        <div class="pt-2 z-30 ">
                                            ...
                                            <div v-else>
                                                <div v-for="selectData in categoryStore.itemList.data"
                                                    ...
                                                    <ps-label class="ms-2"
                                                        :class="selectData.catId == paramHolder1.catId ? ' font-bold' : ''">
                                                        {{ selectData.catName }} </ps-label>
                                ...
                                <template #loadmore>
                                    ...
                                    <div class="mb-2 w-56">
                                        ...
                                        <ps-label class="flex mt-4 ms-4 mb-2 underline font-bold cursor-pointer"
                                            v-if="!categoryStore.isNoMoreRecord" @click="loadCategory"> {{
                            ...
                            <ps-label class="lg:mt-2 mt-1  w-full text-xs" textColor="text-feError-500"
                                v-if="validation.catStatus"> {{ $t("item_entry__category_required_error") }} </ps-label>
                        </div>
                        <!-- end category -->
                        ...
                        <div class="w-full" v-if="appInfoStore?.appInfo?.data?.mobileSetting.is_show_subcategory == '1'">
                            <div class="  mb-4"
                                ...
                                <ps-dropdown align="left" class='lg:mt-2 mt-1  w-full'
                                    @onClick="loadSubCategory(paramHolder1.catId)">
                                    <template #select>
                                                ...
                                                <div v-if="subCategoryStore.subCategoryList.data == null">
                                                    ...
                                                    <div v-else-if="subCategoryStore.loading.value == true">
                                                        <ps-label class='p-2 flex'
                                                            @click="loadSubCategory(paramHolder1.catId)"> {{
                                                                $t("item_entry__loading") }} </ps-label>
                                                    </div>
                                                    <div v-else>
                                                        <ps-label class='p-2 flex'
                                    ...
                                    <template #loadmore>
                                        ...
                                        <div class="mb-2 w-56">
                                            ...
                                            <ps-label v-if="paramHolder1.catId != '' && !subCategoryStore.isNoMoreRecord"
                        ...
                        <div v-if="phoneStatus" class="mb-1 flex flex-col" v-for="(phone, index) in phoneShow" :key="phone">
                            ...
                            <div class="mt-2">
                                <div class="flex flex-row">
                                    ...
                                    <!-- <ps-button class="mx-1" v-if="!(phone == 1 && phoneShow == 1)" @click="removePhone(index)"> -
                                    </ps-button> -->
                                    <!-- <ps-button
                                        v-if="phone < parseInt(appInfoStore.appInfo.data?.mobileSetting?.phone_list_count) && phone == phoneShow"
                                        @click="addPhone()"> +</ps-button> -->
                    ...
                    <div class="flex flex-col sm:flex-row   mb-4">
                        ...
                        <div class=" mb-4  w-full " v-if="appInfoStore.appInfo.data?.psAppSetting?.isSubLocation == '1'">
                            <div v-for="(coreField, index) in customFieldStore.customField.data?.coreList.filter((coreField) => coreField.fieldName === 'location_township_id' && coreField.isVisible === '1')"
                                ...
                                <ps-dropdown align="left" class='lg:mt-2 mt-1  w-full'
                                    @onClick="loadLocationTownship(paramHolder1.itemLocationId)">
                                    <template #select>
                                        <ps-dropdown-select :showCenter="true"
                                    ...
                                    <template #loadmore>
                                        ...
                                        <div class="mb-2 w-56">
                                            ...
                                            <ps-label
                                                v-if="paramHolder1.itemLocationId != '' && !locationTownshipProvider.isNoMoreRecord"
                                                class="flex mt-4 ms-4 mb-2 underline font-bold cursor-pointer"
                                                @click="loadLocationTownship(paramHolder1.itemLocationId)"> {{
                                                    $t("item_entry__load_more") }} </ps-label>
                                        </div>
                    ...
                    <div class="flex flex-col justify-start lg:mt-5 mt-4  font-medium text-base lg:text-lg  mb-4">
                        ...
                        <map-with-pin-picker v-if="appInfoStore?.appInfo?.data?.frontendConfigSetting.googleMap == '1'"
                            class="h-68" :onChange="updateCoordinates" />
...
export default {
    ...
    props: ['thumb2xUrl', 'authUser', 'sysImageUrl', 'itemId','dir'],
    setup(props) {
        ...
        onMounted(async () => {
            ...
            // for(let i=0; i<parseInt(appInfoStore.appInfo.data?.mobileSetting?.phone_list_count); i++) {
            //     phoneList.push({'id': i+1,'value' : ''});
            // }
        ...
        async function submitClicked() {
            ...
            customFieldStore.customField.data?.customList.forEach((customField) => {
                ...
                if ((form.product_relation[customField.coreKeysId] == '' || form.product_relation[customField.coreKeysId] == undefined) && customField.isVisible == '1' && customField.mandatory == '1' && customField.isDelete == '0') {
                    product_relation_errors[customField.coreKeysId] = customField.name + trans('item_entry__field_is_reqiured');
                    errorStatus = false;
                }
            });
            // End
