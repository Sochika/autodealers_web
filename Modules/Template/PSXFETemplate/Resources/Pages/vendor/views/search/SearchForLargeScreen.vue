    ...
    <div class="w-full lg:rounded-lg sm:rounded-xl rounded-2xl sm:flex mt-4 sm:mt-0 gap-5">
        <div class="flex gap-x-5 flex-col md:flex-row gap-y-2">
                ...
                <ps-dropdown align="left" class='w-full md:w-52 h-full lg:rounded-2xl rounded' @onClick="loadSubLocation()">
                    ...
                    <template #filter >
                        <div>
                            <ps-input-with-left-icon rounded="rounded-t-lg" theme="ring-fePrimary-200 dark:ring-feAchromatic-500 focus:outline-none focus:ring focus:border-fePrimary-200 border-feSecondary-300 lg:rounded rounded-x bg-feSecondary-200 dark:bg-feAchromatic-800 text-feSecondary-500 dark:text-feAchromatic-50" height="h-10" @keyup.enter="filtersubLocationUpdate(categoryStore.filterKeyword)" v-model:value="categoryStore.filterKeyword" v-bind:placeholder= "$t('search_categories')" >
                                <template #icon>
                                    <ps-icon textColor="text-fePrimary-500 dark:text-feAchromatic-500" name="search" class='cursor-pointer' @click="filtersubLocationUpdate(categoryStore.filterKeyword)" />
                                </template>
                            </ps-input-with-left-icon>
                        </div>
                    </template>
                ...
                <ps-dropdown :id="locationId ?? 'locaitonid'" align="left" class='w-full md:w-52 h-full lg:rounded-2xl rounded' @onClick="loadLocationList" >
                    ...
                    <template #filter >
                        <div>
                            <ps-input-with-left-icon rounded="rounded-t-lg" theme="ring-fePrimary-200 dark:ring-feAchromatic-500 focus:outline-none focus:ring focus:border-fePrimary-200 border-feSecondary-300 lg:rounded rounded-x bg-feSecondary-200 dark:bg-feAchromatic-800 text-feSecondary-500 dark:text-feAchromatic-50" height="h-10" @keyup.enter="filterKeywordUpate(itemLocationStore.filterKeyword)"  v-model:value="itemLocationStore.filterKeyword" v-bind:placeholder= "$t('search_location')" >
                                <template #icon>
