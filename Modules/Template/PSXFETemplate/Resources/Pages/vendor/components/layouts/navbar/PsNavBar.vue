                            ...
                            <div class="flex items-center">
                                <div class="h-8 w-8 rounded-full">
                                    ...
                                    <img v-else class="object-cover h-8 w-8 rounded-full cursor-pointer"
                                        :src="$page.props.uploadUrl + '/default_profile.png'" :alt="$t('core__be_profile')">
                                </div>
...
export default defineComponent({
    ...
    setup(props) {
        ...
        // const user =  userProvider.loadUser(loginUserId);
        ...
        //     userProfile.value = user.user.data;
        ...
        onMounted(async () => {
            ...
            // await loadUser;
            // console.log(user);
            // submitButtonShow =  isSubmitButtonShow();
            isSubmitButtonShow()
