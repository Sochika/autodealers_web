<template>
    <ps-modal ref="psmodal" maxWidth="480px" line="hidden" :isClickOut='false' theme=" px-6 py-6 rounded-lg shadow-xl" class=' z-50 h-56 bg-feAchromatic-50'>
        <template #title>
            <div class="w-full text-start flex align-middle">
                <div class="h-100">
                    <ps-icon v-if="isTitleWithIcon" class="inline-block me-2 align-middle" name="union" theme="text-feWarning-500" />
                </div>
                <div class="h-100">
