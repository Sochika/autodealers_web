...
//        }
    ...
    public function searchFromApi($request){
        ...
        if(isset($request->keyword) && !empty($request->keyword)){
            ...
            $searchdata->type = $this->subCategoryType;
