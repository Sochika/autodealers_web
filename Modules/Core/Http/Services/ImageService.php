...
class ImageService extends PsService
{
    ...
    public function createThumbnail1x($file, $fileName, $uploadType = null)
    {
        ...
        if ($thumbnail1x->height() > $thumbnail1x->width()) {
            ...
            $thumbnail1x = $thumbnail1x->resize($backend_setting->potrait_thumb_height, $backend_setting->potrait_thumb_height, function ($constraint) {
                // $constraint->aspectRatio();
                // $constraint->upsize();
            });
        }
    ...
    public function createThumbnail2x($file, $fileName, $uploadType = null)
    {
        ...
        if ($thumbnail2x->height() > $thumbnail2x->width()) {
            ...
            $thumbnail2x = $thumbnail2x->resize($backend_setting->potrait_thumb2x_height, $backend_setting->potrait_thumb2x_height, function ($constraint) {
                // $constraint->aspectRatio();
                // $constraint->upsize();
            });
        }
    ...
    public function createThumbnail3x($file, $fileName, $uploadType = null)
    {
        ...
        if ($thumbnail3x->height() > $thumbnail3x->width()) {
            ...
            $thumbnail3x = $thumbnail3x->resize($backend_setting->potrait_thumb3x_height, $backend_setting->potrait_thumb3x_height, function ($constraint) {
                // $constraint->aspectRatio();
                // $constraint->upsize();
            });
        }
