                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2  gap-2 mt-4">
                            <div>
                                <div v-if="title == settingColumn[0].label">
                                    ...
                                    <div class="px-4 py-3">
                                        <google-map-pin-picker :mapKey="$page.props.mapKey" :lat="parseFloat(sysForm.lat)"
                                            :lng="parseFloat(sysForm.lng)" widthHeight="width: 458px; height: 500px"
                                ...
                                <div class="grid grid-rows gap-6 ms-4 me-18" v-if="title == settingColumn[6].label">
                                    ...
                                    <div>
                                        <ps-label
                                            class="text-base">{{ $t('core_mb_setting_default_flutter_currency') }}</ps-label>
                                        <ps-input type="text" v-model:value="form.default_flutter_wave_currency"
                                            :placeholder="$t('core_mb_setting_default_flutter_currency')" />
                                    </div>
                                ...
                                <div v-if="title == settingColumn[8].label">
                                    ...
                                    <div class="px-4 py-3">
                                        <div class="flex items-center">
                                            ...
                                            <ps-tooltip tooltiptext="absolute z-50 bottom-full mb-2 -ms-2.5">
                                                ...
                                                <template #tooltips>
                                                    For more details: <a target="_blank"
                                                        href="https://doc.clickup.com/24312566/p/h/q5yqp-80645/1fb383f3049acb5"
                                                        class="underline">Refer to this doc</a>
                                                </template>
                                            </ps-tooltip>
                                        </div>
                                    ...
                                    <div class="px-4 py-3">
                                        ...
                                        <ps-label-caption textColor="text-secondary-400 mt-1">{{
                                            $t('core_mb_setting_price_format_ex') }}You need to change according to your
                                            format that you need (e.g ",##0.00" => 2,555.00, "##0.00" => 2555.00 ,".00" =>
                                            2555.00, ",##0" => 2,555, ",##0.0" => 2,555.0)</ps-label-caption>
                                    </div>
                                ...
                                <div v-if="title == settingColumn[7].label">
                                 <!-- item price types -->
                                    ...
                                    <div class="px-4 py-3">
                                        <div class="px-4 py-3 flex items-center">
                                            <ps-label class="text-base">{{ $t('core__be_price_types') }}
                                            </ps-label>
                                        </div>
...
export default defineComponent({
    ...
    layout: PsLayout,
    props: ['errors', 'system_config', 'mobile_setting', 'status', 'adTypes'],
    setup(props) {
        ...
        const settingColumn = [
            ...
            //mobile setting end
            {
                label: 'core_sys_item_advance_setting',
