        ...
        @handleSort="handleSorting"  @handleSearch="handleSearching" @handleRow="handleRow"
            ...
            <template #tableActionRow="rowProps">
                ...
                <div class="flex flex-row mb-2" v-if="rowProps.field == 'action'">
                   ...
                   <ps-button :disabled="rowProps.row.authorizations.delete ? rowProps.row.permission_for_delete == '0' : true" @click="confirmDeleteClicked(rowProps.row.id)" colors="bg-red-400 text-white" padding="p-1.5" hover="hover:outline-none hover:ring hover:ring-red-100" focus="focus:outline-none focus:ring focus:ring-red-200" > <ps-icon theme="text-white dark:text-primary-900" name="trash" w="16" h="16" /> </ps-button>
