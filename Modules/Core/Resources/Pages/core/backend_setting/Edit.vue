                    ...
                    <div>
                        <div class="grid grid-cols-1 md:grid-cols-2  gap-2 mt-4">
                            <div>
                                ...
                                <div v-if="title == settingColumn[1].label">
                                    ...
                                    <div class="px-4 py-3"
                                        ...
                                        <ps-label class="text-base">{{ $t(coreField.label_name) }} <span
                                                v-if="coreField.mandatory = 1"
                                                class="text-red-800 font-medium ms-1">*</span></ps-label>
                                        <ps-textarea rows="4" ref="fcm_api_key" v-model:value="form.fcm_api_key"
                                            :placeholder="$t(coreField.placeholder)"
                                            @keyup="coreField.mandatory == 1 ? validateEmptyInput('fcm_api_key', form.fcm_api_key) : ''"
                                            @blur="coreField.mandatory == 1 ? validateEmptyInput('fcm_api_key', form.fcm_api_key) : ''"></ps-textarea>
                                        <ps-label-caption v-if="coreField.mandatory == 1" textColor="text-red-500 "
                                            class="mt-2 block">{{ errors.fcm_api_key }}</ps-label-caption>
                                    </div>
                                ...
                                <div v-if="title == settingColumn[2].label">
                                    ...
                                    <!-- <div class="px-4 py-3">
                                        ...
                                        <ps-label v-if="!backend_setting.backend_water_mask_image[0]" textColor="text-secondary-400 text-xs"> {{ $t('core__be_recommended_size_16_16') }}
                                        </ps-label>
                                        <div v-if="backend_setting.backend_water_mask_image[0]" class="flex items-end pt-4">
                                            <img
                                            v-lazy=" { src: $page.props.uploadUrl + '/' + backend_setting.backend_water_mask_image[0].img_path, loading: $page.props.sysImageUrl+'/loading_gif.gif', error: $page.props.sysImageUrl+'/default_photo.png' }"
                                             width="200" height="200"
                                                class="w-48 h-48" alt="backend_water_mask_image" />
                                            <ps-button type="button" @click="replaceImageClicked(backend_setting.backend_water_mask_image[0].id, false,'backend_water_mask_image)" rounded="rounded-full"
                                        ...
                                        <ps-image-upload v-else class="w-72" uploadType="icon" v-model:imageFile="form.backend_water_mask_image" />
                                    ...
                                    <!-- <div class="px-4 py-3">
                                        ...
                                        <div v-if="backend_setting.backend_login_image[0]" class="flex items-end pt-4">
                                            ...
                                            <ps-button type="button" @click="replaceImageClicked(backend_setting.backend_login_image[0].id,true,'backend_login_image)" rounded="rounded-full"
                                                shadow="drop-shadow-2xl" class="-ms-10 mb-2"
                                                colors="bg-white text-primary-500 dark:bg-secondaryDark-black" border="border border-1 dark:border-secondary-700 border-secondary-300" padding="p-1.5" hover="" focus="">
                                                <ps-icon name="pencil-btn"  w="21" h="21" />
                                            </ps-button>
                                ...
                                <div v-if="title == settingColumn[3].label">
                                    ...
                                    <div class="px-4 py-3">
                                        ...
                                        <ps-label v-if="!backend_setting.backend_logo[0]"
                                        ...
                                        <div v-if="backend_setting.backend_logo[0]" class="flex items-end pt-4">
                                            <img v-lazy="{ src: $page.props.uploadUrl + '/' + backend_setting.backend_logo[0].img_path, loading: $page.props.sysImageUrl + '/loading_gif.gif', error: $page.props.sysImageUrl + '/default_photo.png' }"
                                                width="200" height="200" class="w-48 h-48" alt="backend_setting" />
                                            <ps-button type="button"
                                                @click="replaceImageClicked(backend_setting.backend_logo[0].id, true, 'backend_logo')"
                                        ...
                                        <ps-image-upload v-else class="w-72" uploadType="icon"
                                            v-model:imageFile="form.backend_logo" />
                                    ...
                                    <div class="px-4 py-3">
                                        ...
                                        <ps-label v-if="!backend_setting.fav_icon[0]"
                                        ...
                                        <div v-if="backend_setting.fav_icon[0]" class="flex items-end pt-4">
                                            <img v-lazy="{ src: $page.props.uploadUrl + '/' + backend_setting.fav_icon[0].img_path, loading: $page.props.sysImageUrl + '/loading_gif.gif', error: $page.props.sysImageUrl + '/default_photo.png' }"
                                                width="200" height="200" class="w-48 h-48" alt="fav_icon" />
                                            <ps-button type="button"
                                                @click="replaceImageClicked(backend_setting.fav_icon[0].id, false, 'fav_icon')"
                                                rounded="rounded-full" shadow="drop-shadow-2xl" class="-ms-10 mb-2"
                                                colors="bg-white text-primary-500 dark:bg-secondaryDark-black"
                                                border="border border-1 dark:border-secondary-700 border-secondary-300"
                                                padding="p-1.5" hover="" focus="">
                                        ...
                                        <ps-image-upload v-else class="w-72" uploadType="icon"
                                            v-model:imageFile="form.fav_icon" />
                                    ...
                                    <!-- <div class="px-4 py-3">
                                        ...
                                        <ps-label v-if="!backend_setting.backend_meta_image[0]" textColor="text-secondary-400 text-xs"> {{ $t('core__be_recommended_size_16_16') }}
                                        </ps-label>
                                        <div v-if="backend_setting.backend_meta_image[0]" class="flex items-end pt-4">
                                            <img v-lazy="{ src: $page.props.uploadUrl + '/' + backend_setting.backend_meta_image[0].img_path, loading: $page.props.sysImageUrl + '/loading_gif.gif', error: $page.props.sysImageUrl + '/default_photo.png' }"
                                                width="200" height="200" class="w-48 h-48" alt="backend_meta_image" />
                                            <ps-button type="button"
                                                @click="replaceImageClicked(backend_setting.backend_meta_image[0].id, false, 'backend_meta_image')"
                                                rounded="rounded-full" shadow="drop-shadow-2xl" class="-ms-10 mb-2"
                                                colors="bg-white text-primary-500 dark:bg-secondaryDark-black"
                                                border="border border-1 dark:border-secondary-700 border-secondary-300"
                                                padding="p-1.5" hover="" focus="">
                                        ...
                                        <ps-image-upload v-else class="w-72" uploadType="icon" v-model:imageFile="form.backend_meta_image" />
                                    ...
                                    <div class="px-4 py-3">
                                        ...
                                        <ps-label v-if="!backend_setting.backend_water_mask_image[0]"
                                            textColor="text-secondary-400 text-xs"> {{ $t('core__be_recommended_size_16_16')
                                            }}
                                        </ps-label>
                                        <div v-if="backend_setting.backend_water_mask_image[0]" class="flex items-end pt-4">
                                            <img v-lazy="{ src: $page.props.uploadUrl + '/' + backend_setting.backend_water_mask_image[0].img_path, loading: $page.props.sysImageUrl + '/loading_gif.gif', error: $page.props.sysImageUrl + '/default_photo.png' }"
                                                width="200" height="200" class="w-48 h-48" alt="backend_water_mask_image" />
                                            <ps-button type="button"
                                                @click="replaceImageClicked(backend_setting.backend_water_mask_image[0].id, false, 'backend_water_mask_image')"
                                                rounded="rounded-full" shadow="drop-shadow-2xl" class="-ms-10 mb-2"
                                                colors="bg-white text-primary-500 dark:bg-secondaryDark-black"
                                                border="border border-1 dark:border-secondary-700 border-secondary-300"
                                                padding="p-1.5" hover="" focus="">
                                        ...
                                        <ps-image-upload v-else class="w-72" uploadType="icon"
                                            v-model:imageFile="form.backend_water_mask_image" />
                                        <ps-label-caption textColor="text-red-500 " class="mt-2 block">{{
                                ...
                                <div v-if="title == settingColumn[4].label">
                                    ...
                                    <div class="px-4 py-3"
                                        v-for="(coreField, index) in coreFieldFilterSettings.filter((coreField) => coreField.original_field_name === 'landscape_width' && coreField.enable === 1 && coreField.is_delete === 0)"
                                        :key="index">
                                        <ps-label class="text-base flex flex-row">{{ $t(coreField.label_name) }} <span
                                                v-if="coreField.mandatory = 1"
                                                class="text-red-800 font-medium ms-1">*</span></ps-label>
                                        <ps-input ref="landscape_width" type="text" v-model:value="form.landscape_width"
                                            :placeholder="$t(coreField.placeholder)"
                                            @keyup="coreField.mandatory == 1 ? validateEmptyInput('landscape_width', form.landscape_width) : ''"
                                            @blur="coreField.mandatory == 1 ? validateEmptyInput('landscape_width', form.landscape_width) : ''" />
                                        <ps-label-caption v-if="coreField.mandatory == 1" textColor="text-red-500 "
                                            class="mt-2 block">{{ errors.landscape_width }}</ps-label-caption>
                                    </div>
                                    <div class="px-4 py-3"
                                        v-for="(coreField, index) in coreFieldFilterSettings.filter((coreField) => coreField.original_field_name === 'potrait_height' && coreField.enable === 1 && coreField.is_delete === 0)"
                                        :key="index">
                                        <ps-label class="text-base flex flex-row">{{ $t(coreField.label_name) }} <span
                                                v-if="coreField.mandatory = 1"
                                                class="text-red-800 font-medium ms-1">*</span></ps-label>
                                        <ps-input ref="potrait_height" type="text" v-model:value="form.potrait_height"
                                            :placeholder="$t(coreField.placeholder)"
                                            @keyup="coreField.mandatory == 1 ? validateEmptyInput('potrait_height', form.potrait_height) : ''"
                                            @blur="coreField.mandatory == 1 ? validateEmptyInput('potrait_height', form.potrait_height) : ''" />
                                        <ps-label-caption v-if="coreField.mandatory == 1" textColor="text-red-500 "
                                            class="mt-2 block">{{ errors.potrait_height }}</ps-label-caption>
                                    </div>
                                    <div class="px-4 py-3"
                                        v-for="(coreField, index) in coreFieldFilterSettings.filter((coreField) => coreField.original_field_name === 'square_height' && coreField.enable === 1 && coreField.is_delete === 0)"
                                        :key="index">
                                        <ps-label class="text-base flex flex-row">{{ $t(coreField.label_name) }} <span
                                                v-if="coreField.mandatory = 1"
                                                class="text-red-800 font-medium ms-1">*</span></ps-label>
                                        <ps-input ref="square_height" type="text" v-model:value="form.square_height"
                                            :placeholder="$t(coreField.placeholder)"
                                            @keyup="coreField.mandatory == 1 ? validateEmptyInput('square_height', form.square_height) : ''"
                                            @blur="coreField.mandatory == 1 ? validateEmptyInput('square_height', form.square_height) : ''" />
                                        <ps-label-caption v-if="coreField.mandatory == 1" textColor="text-red-500 "
                                            class="mt-2 block">{{ errors.square_height }}</ps-label-caption>
                                    </div>

                                    <ps-label class="text-lg px-4 py-3">{{ $t('core__thumb1x_img_size') }}</ps-label>
                                    <div class="px-4 py-3"
                                        v-for="(coreField, index) in coreFieldFilterSettings.filter((coreField) => coreField.original_field_name === 'landscape_thumb_width' && coreField.enable === 1 && coreField.is_delete === 0)"
                                        :key="index">
                                        <ps-label class="text-base flex flex-row">{{ $t(coreField.label_name) }} <span
                                                v-if="coreField.mandatory = 1"
                                                class="text-red-800 font-medium ms-1">*</span></ps-label>
                                        <ps-input ref="landscape_thumb_width" type="text"
                                            v-model:value="form.landscape_thumb_width"
                                            :placeholder="$t(coreField.placeholder)"
                                            @keyup="coreField.mandatory == 1 ? validateEmptyInput('landscape_thumb_width', form.landscape_thumb_width) : ''"
                                            @blur="coreField.mandatory == 1 ? validateEmptyInput('landscape_thumb_width', form.landscape_thumb_width) : ''" />
                                        <ps-label-caption v-if="coreField.mandatory == 1" textColor="text-red-500 "
                                            class="mt-2 block">{{ errors.landscape_thumb_width }}</ps-label-caption>
                                    </div>
                                    <div class="px-4 py-3"
                                        v-for="(coreField, index) in coreFieldFilterSettings.filter((coreField) => coreField.original_field_name === 'potrait_thumb_height' && coreField.enable === 1 && coreField.is_delete === 0)"
                                        :key="index">
                                        <ps-label class="text-base flex flex-row">{{ $t(coreField.label_name) }} <span
                                                v-if="coreField.mandatory = 1"
                                                class="text-red-800 font-medium ms-1">*</span></ps-label>
                                        <ps-input ref="potrait_thumb_height" type="text"
                                            v-model:value="form.potrait_thumb_height"
                                            :placeholder="$t(coreField.placeholder)"
                                            @keyup="coreField.mandatory == 1 ? validateEmptyInput('potrait_thumb_height', form.potrait_thumb_height) : ''"
                                            @blur="coreField.mandatory == 1 ? validateEmptyInput('potrait_thumb_height', form.potrait_thumb_height) : ''" />
                                        <ps-label-caption v-if="coreField.mandatory == 1" textColor="text-red-500 "
                                            class="mt-2 block">{{ errors.potrait_thumb_height }}</ps-label-caption>
                                    </div>
                                    <div class="px-4 py-3"
                                        v-for="(coreField, index) in coreFieldFilterSettings.filter((coreField) => coreField.original_field_name === 'square_thumb_height' && coreField.enable === 1 && coreField.is_delete === 0)"
                                        :key="index">
                                        <ps-label class="text-base flex flex-row">{{ $t(coreField.label_name) }} <span
                                                v-if="coreField.mandatory = 1"
                                                class="text-red-800 font-medium ms-1">*</span></ps-label>
                                        <ps-input ref="square_thumb_height" type="text"
                                            v-model:value="form.square_thumb_height"
                                            :placeholder="$t(coreField.placeholder)"
                                            @keyup="coreField.mandatory == 1 ? validateEmptyInput('square_thumb_height', form.square_thumb_height) : ''"
                                            @blur="coreField.mandatory == 1 ? validateEmptyInput('square_thumb_height', form.square_thumb_height) : ''" />
                                        <ps-label-caption v-if="coreField.mandatory == 1" textColor="text-red-500 "
                                            class="mt-2 block">{{ errors.square_thumb_height }}</ps-label-caption>
                                    </div>

                                    <ps-label class="text-lg px-4 py-3">{{ $t('core__thumb2x_img_size') }}</ps-label>
                                    <div class="px-4 py-3"
                                        v-for="(coreField, index) in coreFieldFilterSettings.filter((coreField) => coreField.original_field_name === 'landscape_thumb2x_width' && coreField.enable === 1 && coreField.is_delete === 0)"
                                        :key="index">
                                        <ps-label class="text-base flex flex-row">{{ $t(coreField.label_name) }} <span
                                                v-if="coreField.mandatory = 1"
                                                class="text-red-800 font-medium ms-1">*</span></ps-label>
                                        <ps-input ref="landscape_thumb2x_width" type="text"
                                            v-model:value="form.landscape_thumb2x_width"
                                            :placeholder="$t(coreField.placeholder)"
                                            @keyup="coreField.mandatory == 1 ? validateEmptyInput('landscape_thumb2x_width', form.landscape_thumb2x_width) : ''"
                                            @blur="coreField.mandatory == 1 ? validateEmptyInput('landscape_thumb2x_width', form.landscape_thumb2x_width) : ''" />
                                        <ps-label-caption v-if="coreField.mandatory == 1" textColor="text-red-500 "
                                            class="mt-2 block">{{ errors.landscape_thumb2x_width }}</ps-label-caption>
                                    </div>
                                    <div class="px-4 py-3"
                                        v-for="(coreField, index) in coreFieldFilterSettings.filter((coreField) => coreField.original_field_name === 'potrait_thumb2x_height' && coreField.enable === 1 && coreField.is_delete === 0)"
                                        :key="index">
                                        <ps-label class="text-base flex flex-row">{{ $t(coreField.label_name) }} <span
                                                v-if="coreField.mandatory = 1"
                                                class="text-red-800 font-medium ms-1">*</span></ps-label>
                                        <ps-input ref="potrait_thumb2x_height" type="text"
                                            v-model:value="form.potrait_thumb2x_height"
                                            :placeholder="$t(coreField.placeholder)"
                                            @keyup="coreField.mandatory == 1 ? validateEmptyInput('potrait_thumb2x_height', form.potrait_thumb2x_height) : ''"
                                            @blur="coreField.mandatory == 1 ? validateEmptyInput('potrait_thumb2x_height', form.potrait_thumb2x_height) : ''" />
                                        <ps-label-caption v-if="coreField.mandatory == 1" textColor="text-red-500 "
                                            class="mt-2 block">{{ errors.potrait_thumb2x_height }}</ps-label-caption>
                                    </div>
                                    <div class="px-4 py-3"
                                        v-for="(coreField, index) in coreFieldFilterSettings.filter((coreField) => coreField.original_field_name === 'square_thumb2x_height' && coreField.enable === 1 && coreField.is_delete === 0)"
                                        :key="index">
                                        <ps-label class="text-base flex flex-row">{{ $t(coreField.label_name) }} <span
                                                v-if="coreField.mandatory = 1"
                                                class="text-red-800 font-medium ms-1">*</span></ps-label>
                                        <ps-input ref="square_thumb2x_height" type="text"
                                            v-model:value="form.square_thumb2x_height"
                                            :placeholder="$t(coreField.placeholder)"
                                            @keyup="coreField.mandatory == 1 ? validateEmptyInput('square_thumb2x_height', form.square_thumb2x_height) : ''"
                                            @blur="coreField.mandatory == 1 ? validateEmptyInput('square_thumb2x_height', form.square_thumb2x_height) : ''" />
                                        <ps-label-caption v-if="coreField.mandatory == 1" textColor="text-red-500 "
                                            class="mt-2 block">{{ errors.square_thumb2x_height }}</ps-label-caption>
                                    </div>

                                    <ps-label class="text-lg px-4 py-3">{{ $t('core__thumb3x_img_size') }}</ps-label>
                                    <div class="px-4 py-3"
                                        v-for="(coreField, index) in coreFieldFilterSettings.filter((coreField) => coreField.original_field_name === 'landscape_thumb3x_width' && coreField.enable === 1 && coreField.is_delete === 0)"
                                        :key="index">
                                        <ps-label class="text-base flex flex-row">{{ $t(coreField.label_name) }} <span
                                                v-if="coreField.mandatory = 1"
                                                class="text-red-800 font-medium ms-1">*</span></ps-label>
                                        <ps-input ref="landscape_thumb3x_width" type="text"
                                            v-model:value="form.landscape_thumb3x_width"
                                            :placeholder="$t(coreField.placeholder)"
                                            @keyup="coreField.mandatory == 1 ? validateEmptyInput('landscape_thumb3x_width', form.landscape_thumb3x_width) : ''"
                                            @blur="coreField.mandatory == 1 ? validateEmptyInput('landscape_thumb3x_width', form.landscape_thumb3x_width) : ''" />
                                        <ps-label-caption v-if="coreField.mandatory == 1" textColor="text-red-500 "
                                            class="mt-2 block">{{ errors.landscape_thumb3x_width }}</ps-label-caption>
                                    </div>
                                    <div class="px-4 py-3"
                                        v-for="(coreField, index) in coreFieldFilterSettings.filter((coreField) => coreField.original_field_name === 'potrait_thumb3x_height' && coreField.enable === 1 && coreField.is_delete === 0)"
                                        :key="index">
                                        <ps-label class="text-base flex flex-row">{{ $t(coreField.label_name) }} <span
                                                v-if="coreField.mandatory = 1"
                                                class="text-red-800 font-medium ms-1">*</span></ps-label>
                                        <ps-input ref="potrait_thumb3x_height" type="text"
                                            v-model:value="form.potrait_thumb3x_height"
                                            :placeholder="$t(coreField.placeholder)"
                                            @keyup="coreField.mandatory == 1 ? validateEmptyInput('potrait_thumb3x_height', form.potrait_thumb3x_height) : ''"
                                            @blur="coreField.mandatory == 1 ? validateEmptyInput('potrait_thumb3x_height', form.potrait_thumb3x_height) : ''" />
                                        <ps-label-caption v-if="coreField.mandatory == 1" textColor="text-red-500 "
                                            class="mt-2 block">{{ errors.potrait_thumb3x_height }}</ps-label-caption>
                                    </div>
                                    <div class="px-4 py-3"
                                        v-for="(coreField, index) in coreFieldFilterSettings.filter((coreField) => coreField.original_field_name === 'square_thumb3x_height' && coreField.enable === 1 && coreField.is_delete === 0)"
                                        :key="index">
                                        <ps-label class="text-base flex flex-row">{{ $t(coreField.label_name) }} <span
                                                v-if="coreField.mandatory = 1"
                                                class="text-red-800 font-medium ms-1">*</span></ps-label>
                                        <ps-input ref="square_thumb3x_height" type="text"
                                            v-model:value="form.square_thumb3x_height"
                                            :placeholder="$t(coreField.placeholder)"
                                            @keyup="coreField.mandatory == 1 ? validateEmptyInput('square_thumb3x_height', form.square_thumb3x_height) : ''"
                                            @blur="coreField.mandatory == 1 ? validateEmptyInput('square_thumb3x_height', form.square_thumb3x_height) : ''" />
                                        <ps-label-caption v-if="coreField.mandatory == 1" textColor="text-red-500 "
                                            class="mt-2 block">{{ errors.square_thumb3x_height }}</ps-label-caption>
                                    </div>
                                    <!--end-->
                                </div>
                                ...
                                <div v-if="title == settingColumn[8].label">
                                    ...
                                    <div v-if="form.is_watermask == 1">
                                        ...
                                        <div class="px-4 py-3">
                                            ...
                                            <ps-label v-if="!backend_setting.water_mask_background[0]"
                                                textColor="text-secondary-400 text-xs"> {{
                                                    $t('core__be_recommended_size_16_16') }}
                                            </ps-label>
                                            <div v-if="backend_setting.water_mask_background[0]"
                                                class="flex items-end pt-4">
                                                <img v-lazy="{ src: $page.props.uploadUrl + '/' + backend_setting.water_mask_background[0].img_path, loading: $page.props.sysImageUrl + '/loading_gif.gif', error: $page.props.sysImageUrl + '/default_photo.png' }"
                                                    width="200" height="200" class="w-48 h-48"
                                                    alt="water_mask_background" />
                                                <ps-button type="button"
                                                    @click="replaceImageClicked(backend_setting.water_mask_background[0].id, false, 'water_mask_background', 'preview')"
                                                    rounded="rounded-full" shadow="drop-shadow-2xl" class="-ms-10 mb-2"
                                                    colors="bg-white text-primary-500 dark:bg-secondaryDark-black"
                                                    border="border border-1 dark:border-secondary-700 border-secondary-300"
                                                    padding="p-1.5" hover="" focus="">
                                            ...
                                            <ps-image-upload v-else class="w-72" uploadType="icon"
                                                v-model:imageFile="form.water_mask_background" />
                                            <ps-label-caption textColor="text-red-500 " class="mt-2 block">{{
                                        ...
                                        <div class="container mx-auto grid-cols-4 lg:space-y-0  lg:gap-2 lg:grid  lg:grid-cols-4"
                                            ...
                                            <div v-if="backend_setting.water_mask_background[0] && reRenderImage && backend_setting.water_mask_background_org[0]"
                                                ...
                                                <img class="object-cointain"
                                                    v-lazy="{ src: $page.props.uploadUrl + '/' + backend_setting.water_mask_background_org[0].img_path + '?timestamp=' + reRenderTime, loading: $page.props.sysImageUrl + '/loading_gif.gif', error: $page.props.sysImageUrl + '/default_photo.png' }"
                                                    alt="water_mask_background" />
                                            ...
                                            <div v-if="backend_setting.water_mask_background[0] && reRenderImage && backend_setting.water_mask_background_org[0]"
                                                ...
                                                <img class="object-cointain"
                                                    v-lazy="{ src: $page.props.thumb1xUrl + '/' + backend_setting.water_mask_background_org[0].img_path + '?timestamp=' + reRenderTime, loading: $page.props.sysImageUrl + '/loading_gif.gif', error: $page.props.sysImageUrl + '/default_photo.png' }"
                                            ...
                                            <div v-if="backend_setting.water_mask_background[0] && reRenderImage && backend_setting.water_mask_background_org[0]"
                                                class="w-full dark:bg-secondary-900 bg-secondary-000 rounded hover:shadow-2xl grid place-items-center content-end">
                                                <img class="object-cointain"
                                                    v-lazy="{ src: $page.props.thumb2xUrl + '/' + backend_setting.water_mask_background_org[0].img_path + '?timestamp=' + reRenderTime, loading: $page.props.sysImageUrl + '/loading_gif.gif', error: $page.props.sysImageUrl + '/default_photo.png' }"
                                            ...
                                            <div v-if="backend_setting.water_mask_background[0] && reRenderImage && backend_setting.water_mask_background_org[0]"
                                                class="w-full dark:bg-secondary-900 bg-secondary-000 rounded hover:shadow-2xl grid place-items-center content-end ">
                                                <img class="object-cointain"
                                                    v-lazy="{ src: $page.props.thumb3xUrl + '/' + backend_setting.water_mask_background_org[0].img_path + '?timestamp=' + reRenderTime, loading: $page.props.sysImageUrl + '/loading_gif.gif', error: $page.props.sysImageUrl + '/default_photo.png' }"
                                ...
                                <div v-if="title == settingColumn[11].label">
                                    ...
                                    <div class="px-4 py-3"
                                        ...
                                        <div class="flex items-center">
                                            <ps-label class="text-base">{{ $t(coreField.label_name) }} {{
                                                coreField.label_name }} <span v-if="coreField.mandatory = 1"
                                                    class="text-red-800 font-medium ms-1">*</span></ps-label>
                                            <ps-tooltip tooltiptext="absolute z-50 bottom-full ms-0.5">
                                                <template #content>
                                                    <ps-icon name="info" w="20" h="20"
                                    ...
                                    <!-- <div class="px-4 py-3" v-for="(coreField, index) in coreFieldFilterSettings.filter((coreField) => coreField.original_field_name === 'user_social_info_override' && coreField.enable === 1 && coreField.is_delete === 0)" :key="index">
                                        <ps-label class="ms-2 text-xs" textColor="text-secondary-400">{{ "fe_setting" }}</ps-label>
                                    </div> -->
                                    ...
                                    <div class="px-4 py-3"
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <ps-tooltip tooltiptext="absolute z-50 bottom-full ms-0.5">
                                                ...
                                                <template #tooltips>
                                                    For more details: <a target="_blank"
                                                        href="https://doc.clickup.com/24312566/p/h/q5yqp-158984/6004a6ecd2e11ec"
                                                        class="underline">Refer to this doc</a>
                                                </template>
                                            </ps-tooltip>
                                        </div>
                                                            ...
                                                            <div>
                                                                <ps-label
                                                                    class="dark:text-white text-secondary-800 font-normal">{{
                                                                        $t('lang_refresh_desc') }}</ps-label>
                                                            </div>
                                                            <div v-if="can.deleteDataReset"
                                                                class="flex flex-row justify-start mt-6">
                                                                <ps-button @click="handleLangRefresh()" rounded="rounded"
                                ...
                                <div v-if="title == settingColumn[2].label"
                                    class="pt-6 border-t border-secondary-800 dark:border-secondary-100">
                                    <div class="p-4 border border-secondary-100 rounded-lg">
                                        ...
                                        <div class="">
                                            <ps-label class="text-base mb-1">{{ $t('core__be_smtp_check_email_label') }}
                                            </ps-label>
                                        ...
                                        <div class="flex flex-row pt-2 justify-end">
                                            ...
                                            <ps-button @click="checkSmtpConfiguration()"
                                                ...
                                                <ps-label v-if="!loadingSmtp && !successSmtp"
                                                    textColor="text-white dark:text-secondaryDark-black">
                                                    {{ $t('core__be_btn_confirm') }} </ps-label>
                                            </ps-button>
                                        </div>
                            ...
                            <div class="px-4">
                                ...
                                <div v-for="column in settingColumn.slice(1)" :key="column.id">
...
export default defineComponent({
    ...
    layout: PsLayout,
    props: ['errors', 'backend_setting', 'commonColor', 'status', 'coreFieldFilterSettings', 'can', 'validation', 'paddingList', 'uploadSettingList'],
    setup(props) {
        ...
        let form = useForm(
            {
                ...
                is_google_map: props.backend_setting.is_google_map == 1 ? "is_google_map" : "is_open_street_map",
                is_open_street_map: props.backend_setting.is_open_street_map == 1 ? true : false,
                fe_setting: props.backend_setting.fe_setting == 1 ? true : false,
                // original_water_mask:props.backend_setting.water_mask_background_org[0].img_path,
                "_method": "put"
            }
        )
        ...
        const title = ref(settingColumn[1].label);
        const docu = ref(settingColumn[1].docu);
