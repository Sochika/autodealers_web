                    ...
                    <form @submit.prevent="handleSubmit(this.township.id)">
                        <div class="grid w-full sm:w-1/2 gap-6">
                            ...
                            <div class="mb-6" v-else>
                                <open-street-map-pin-picker :dir="$page.props.dir" :onChange="setCoordinates" :lat="parseFloat(form.lat)" :lng="parseFloat(form.lng)" class="h-[500px]" />
                            </div>
                            <!-- maps end -->
...
export default defineComponent({
    ...
    layout: PsLayout,
    props: ['errors', 'township', 'cities', 'backendSettings'],
    data() {
        return {
    ...
    setup(props) {
        ...
        return { validateTownshipNameInput, setCoordinates, validateCityNameInput, validateLatitudeInput, validateLongitudeInput, onlyNumber, onlyNumberWithCustom, form, handleSubmit, updateCoordinates, loading, success, name, location_city_id, lat, lng }
    },
    computed: {
        breadcrumb() {
            return [
