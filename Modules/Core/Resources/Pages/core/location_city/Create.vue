                        ...
                        <div class="grid w-full sm:w-1/2 gap-6">
                            <div>
                                ...
                                <ps-input
                                    ...
                                    :placeholder="$t('core__be_city_name_input_placeholde')"
                                    @keyup="
                            ...
                            <!-- <div>
                                <google-map-pin-picker :mapKey="$page.props.mapKey" 
                            ...
                            >
                                ...
                                <ps-label v-show="custom_field_header.mandatory == 1" class="text-base mb-2">{{ $t(custom_field_header.name) }}<span class="text-red-800 font-medium ms-1">*</span></ps-label>
                                    <ps-input
                                        type="text"
                                ...
                                <div
                                    ...
                                    "
                                >
                                    <ps-label class="text-base">{{ $t(custom_field_header.name) }}
                                        <ps-label
...
// import OpenStreetMap from "@/Components/Core/Map/OpenStreetMapPinPicker.vue";
// import GoogleMapPinPicker from "@/Components/Core/Map/GoogleMapPinPicker.vue";
    ...
    setup(props) {
        ...
        function handleCustomFieldNumberError(custom_field_header) {
            custom_field_header.mandatory === 1
                ? validateNumberInput(
                      custom_field_header.name,
                      form.product_relation[custom_field_header.core_keys_id],
                      "The " +
