...
export default defineComponent({
    ...
    layout: PsLayout,
    props: ['errors', 'data_deletion_policy', 'status', 'domain', 'dir'],
    setup(props) {
        ...
        let appDomain = props.domain;

        let subFolder = props.dir;
        ...
        if (!subFolder) {
         ...
         const datadeletionurl = appUrl + 'app_content/datadelection';
